...
import FixedRateChart from '@/components/rate-charts/FixedRateChart';
import {
    Calculator,
    Plus,
    Edit,
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-1">
                        Configure milk pricing - Simple fixed rates or advanced FAT/SNF based pricing
                    </p>
                </div>
            </div>

            {/* Mode Tabs - Like Competitor */}
            <Tabs defaultValue="simple" className="w-full">
                <TabsList className="grid w-full max-w-md grid-cols-2 bg-gray-100 dark:bg-gray-800 rounded-xl p-1">
                    <TabsTrigger value="simple" className="rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700">
                        <Zap className="w-4 h-4 mr-2" />
                        Simple Mode
                    </TabsTrigger>
                    <TabsTrigger value="advanced" className="rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700">
                        <Calculator className="w-4 h-4 mr-2" />
                        Advanced Mode
                    </TabsTrigger>
                </TabsList>

                {/* Simple Mode - Fixed Rate Chart (like Hamari Dairy) */}
                <TabsContent value="simple" className="mt-6">
                    <FixedRateChart />
                </TabsContent>

                {/* Advanced Mode - FAT/SNF Based Rate Charts */}
