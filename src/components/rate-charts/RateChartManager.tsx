    ...
    const fetchCharts = async () => {
        ...
        try {
            ...
            setCharts([
                ...
                {
                    id: '2',
                    name: 'Buffalo Premium',
                    cattleType: 'BUFFALO',
                    isActive: true,
                    effectiveFrom: '2026-01-01',
                    entries: [
                        { id: '7', fatMin: 5.0, fatMax: 5.4, ratePerLiter: 48 },
                        { id: '8', fatMin: 5.5, fatMax: 5.9, ratePerLiter: 52 },
                        { id: '9', fatMin: 6.0, fatMax: 6.4, ratePerLiter: 56 },
                        { id: '10', fatMin: 6.5, fatMax: 7.0, ratePerLiter: 60 },
                    ]
                }
            ])
        } catch (error) {
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">
                        Configure milk pricing based on FAT and SNF
                    </p>
                </div>
                            ...
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <CardDescription>
                                            Effective from {selectedChart.effectiveFrom}
                                        </CardDescription>
                                    </div>
