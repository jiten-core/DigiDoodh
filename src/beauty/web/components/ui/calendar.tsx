...
function CalendarDayButton({
  ...
  React.useEffect(() => {
    if ((modifiers as Modifiers)?.focused) ref.current?.focus()
  }, [(modifiers as Modifiers)?.focused])
  ...
  return (
    <Button
      ...
      data-selected-single={
        (modifiers as Modifiers)?.selected &&
        !(modifiers as Modifiers)?.range_start &&
        !(modifiers as Modifiers)?.range_end &&
        !(modifiers as Modifiers)?.range_middle
      }
      data-range-start={(modifiers as Modifiers)?.range_start}
      data-range-end={(modifiers as Modifiers)?.range_end}
      data-range-middle={(modifiers as Modifiers)?.range_middle}
      className={cn(
        "data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground dark:hover:text-accent-foreground flex aspect-square w-full min-w-8 flex-col gap-1 leading-none font-normal data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
