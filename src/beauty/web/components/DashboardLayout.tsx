...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const { user, profile, logout, checkAccess } = useAuth();
  ...
  const navigation = [
    {
      ...
      roles: ['DAIRY_OWNER', 'STAFF', 'FARMER', 'INTERNAL_SUPER_ADMIN', 'PLATFORM_SUPER_ADMIN']
    },
    {
      name: t('nav.milkCollection', isFarmer ? 'Milk History' : 'Milk Collection'),
      nameHi: isFarmer ? 'दूध का हिसाब' : 'दूध संग्रहण',
      href: '/dashboard/milk',
      icon: Milk,
      roles: ['DAIRY_OWNER', 'STAFF', 'FARMER', 'INTERNAL_SUPER_ADMIN', 'PLATFORM_SUPER_ADMIN']
    },
    {
      ...
      icon: Users,
      roles: ['DAIRY_OWNER', 'STAFF', 'INTERNAL_SUPER_ADMIN']
    },
    {
      ...
      icon: ShoppingCart,
      roles: ['DAIRY_OWNER', 'STAFF', 'INTERNAL_SUPER_ADMIN'],
      feature: 'buyer_management'
    },
    {
      name: t('nav.products', isFarmer ? 'Products' : 'Products'),
      nameHi: isFarmer ? 'सामान' : 'उत्पाद',
      href: '/dashboard/products',
      icon: Package,
      roles: ['DAIRY_OWNER', 'STAFF', 'FARMER', 'INTERNAL_SUPER_ADMIN']
    },
    {
    ...
    },
    {
      ...
      icon: Users,
      roles: ['DAIRY_OWNER', 'INTERNAL_SUPER_ADMIN']
    },
    {
    ...
    if (item.feature && profile?.role !== 'PLATFORM_SUPER_ADMIN' && profile?.role !== 'INTERNAL_SUPER_ADMIN') {
      return checkAccess?.(item.feature as any) ?? true;
    }
    return true;
  });
